...
import * as GoodsSkuApi from '@/api/goods/goodsSku'
import CategoryModel from '@/common/model/Category'
import { STable, GoodsSkuItem } from '@/components/Table'
...
export default {
    ...
    data() {
        return {
            ...
            loadData: (param) => {
                return GoodsSkuApi.listByWhere({
                    ...param,
                    ...this.queryParam,
                }).then((response) => {
    ...
    methods: {
        ...
        loadDataList() {
            ...
            GoodsSkuApi.listByWhere(this.queryParam).then((response) => {
