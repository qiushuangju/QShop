      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(res => {
          this.localPagination = this.showPagination && Object.assign({}, this.localPagination, {
            current: res.current_page, // 返回结果中的当前分页数
            total: res.total, // 返回结果中的总记录数
            showSizeChanger: this.showSizeChanger,
            pageSize: (pagination && pagination.pageSize) ||
		  ...
		  console.log("res",res)
          if (res.result.length === 0 && this.showPagination && this.localPagination.current > 1) {
          ...
          try {
            if ((['auto', true].includes(this.showPagination) && res.total <= (res.current_page * this.localPagination.pageSize))) {
          ...
          this.localDataSource =res.result // 返回结果中的数组数据
