        ...
        <a-spin :spinning="isLoading">
            <div class="container clearfix">
                ...
                <div class="preview fl-l">
                    <img v-if="form.getFieldValue('style')" :src="`static/img/category/${form.getFieldValue('style')}.png`" />
                </div>
                <!-- 表单内容 -->
                <div class="form-box fl-r">
                  ...
                  'style',
                  {
                    initialValue: PageCategoryStyleEnum.TWO_LEVEL.value,
                    rules: [{ required: true }],
                  },
                ]">
                  ...
                  " class="extra">
                                ...
                                <p v-if="
                    form.getFieldValue('style') ==
                    PageCategoryStyleEnum.TWO_LEVEL.value
                  " class="extra">
                                    分类图尺寸：宽150像素 高150像素
                                </p>
                            </div>
...
export default {
    ...
    methods: {
        ...
        setFieldsValue() {
            ...
            // 表单内容
            this.$nextTick(() => {
                setFieldsValue(_.pick(record, ['style', 'share_title']))
            })
        },
        ...
        onFormSubmit(values) {
            this.isLoading = true
            Api.addOrUpdate(this.key, { form: values })
                .then((result) => {
                    // 显示提示信息
