    ...
    <a-card :bordered="false">
        ...
        <a-spin :spinning="isLoading">
            <a-form :form="form" @submit="handleSubmit">
                ...
                <a-form-item label="商城" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select v-decorator="['storeId',{rules: [{ required: true, message: '请选择商城' }]}]" placeholder="请选择" :filterOption=true>
        ...
        getDetail() {
            ...
            coupon
                ...
                .then((result) => {
                    // 当前记录
                    if (
                        result.result.applyRangeConfig != null &&
                        result.result.applyRangeConfig != ''
                    )
                        result.result.applyRangeConfig =
                            result.result.applyRangeConfig.split(',')
                    this.record = result.result
                    if (
                        result.result.showImg != null &&
                        result.result.showImg != ''
                    ) {
                        this.defaultImgList.push({
                            id: result.result.showImg,
                            thumbnail: result.result.urlHomeImg,
                        })
                    }
                    // 设置表单默认值
                    this.setFieldsValue()
