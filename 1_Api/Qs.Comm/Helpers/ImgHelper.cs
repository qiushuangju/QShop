// <copyright file="ImgHelper.cs" company="Qs.net.cn">
// Copyright (c) 2019 Qs.net.cn. All rights reserved.
// </copyright>
// <author>www.cnblogs.com/Qs</author>
...
namespace Qs.Comm.Helpers
{
    public class ImgHelper
    {
        ...
        public static void MakeThumbnail(string originalImagePath,
            ...
            int width = 750, int height = 90, string mode = "W")
        {
